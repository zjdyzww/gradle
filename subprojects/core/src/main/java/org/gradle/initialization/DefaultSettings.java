...
public abstract class DefaultSettings extends AbstractPluginAware implements SettingsInternal {
    ...
    public DefaultSettings(ServiceRegistryFactory serviceRegistryFactory,
        ...
        this.dependencyResolutionManagement = instantiator.newInstance(DefaultDependencyResolutionManagement.class, (Supplier<CrossProjectResolutionServices>) () -> services.get(CrossProjectResolutionServices.class));
    }
    ...
    public boolean isCrossProjectResolutionConsistencyEnabled() {
        return dependencyResolutionManagement.isCrossProjectResolutionConsistencyEnabled();
    }
