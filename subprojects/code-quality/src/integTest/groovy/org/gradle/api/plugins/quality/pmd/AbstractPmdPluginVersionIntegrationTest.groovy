...
@TargetVersions([PmdPlugin.DEFAULT_PMD_VERSION, '4.3', '5.0.5', '5.1.1', '5.3.3', '6.0.0', '6.15.0'])
abstract class AbstractPmdPluginVersionIntegrationTest extends MultiVersionIntegrationSpec {
